...
class LocationPageForOnpress extends StatefulWidget {
  final String latitude;
  final String longitude;

  const LocationPageForOnpress({
    Key? key,
  ...
  @override
  State<LocationPageForOnpress> createState() => _LocationPageForOnpressState();
}
...
class _LocationPageForOnpressState extends State<LocationPageForOnpress> {
  String? latitude;
  String? longitude;
