...
class WeatherPagebyzip extends StatefulWidget {
  final String location;
  final String countrycode;
  // Callback function
  const WeatherPagebyzip({
    Key? key,
  ...
  @override
  State<WeatherPagebyzip> createState() => _WeatherPageState();
}

class _WeatherPageState extends State<WeatherPagebyzip> {
  final ApiServicesforzip apiServicesfromzip = ApiServicesforzip();
        ...
        child: Column(
          children: [
            FutureBuilder<Map<String, dynamic>>(
              future: apiServicesfromzip.getWeatherData(
                widget.location,
                widget.countrycode,
              ),
